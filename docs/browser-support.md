...
Last verified: 2026-07-26 with Playwright 1.61.1.
...
Beta.4 totals on 2026-07-26 were Chromium 54 passed; Firefox 50 passed and 4 skipped; WebKit 50 passed and 4 skipped. The AI model picker, including deterministic sorting, filtering, selection persistence, fallback labeling, and checkbox geometry, passes in all three engines. The skips are dedicated Chromium release scenarios, not failures of the cross-browser AI or real renderer matrices.
